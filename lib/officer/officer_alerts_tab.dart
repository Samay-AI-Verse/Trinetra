...
class OfficerAlertsTab extends StatefulWidget {
  ...
  const OfficerAlertsTab({super.key, required this.officerId});
...
class _OfficerAlertsTabState extends State<OfficerAlertsTab> {
  ...
  Future<void> _initializeNotifications() async {
    ...
    await _notificationService.initialize(widget.officerId);
  ...
  void _showNotificationToast(Map<String, dynamic> notification) {
    final isEmergency =
        ...
        notification['type'] == 'officer_sos_alert';
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              Text(
                'Real-time notifications from command center',
        ...
        children: [
          Container(
            ...
            child: Icon(
              ...
              color: isEmergency ? const Color(0xFFDC2626) : Colors.blue,
              size: 24,
            ),
          ),
          const SizedBox(width: 12),
